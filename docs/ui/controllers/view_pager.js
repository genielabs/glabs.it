...
zuix.controller(function(cp) {
    ...
    function updateLayout() {
        ...
        updateLayoutTimeout = setTimeout(layoutElements, 2500);
    }
    function layoutElements() {
        ...
        pageList.each(function(i, el) {
            if (i == 0) {
                ...
                //cp.view().css({width: el.clientWidth+'px', height: el.clientHeight+'px'});
            }
            this.css({
                'position': 'absolute',
                'left': 0,
        ...
        if (viewSize.width === 0 || viewSize.height === 0) {
            ...
            console.log(cp.context.contextId, pageList.length());
            updateLayout();
            return;
        }
        // position elements
